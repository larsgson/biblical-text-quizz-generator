  ...
  return (
    <div className="flex h-full flex-col">
      <div className="border-b border-gray-200 px-3 py-2">
        ...
        <p className="text-xs text-gray-400">Ask questions about biblical texts</p>
      </div>
      ...
      <div className="flex-1 overflow-y-auto p-3 space-y-3">
        {messages.length === 0 && (
          <div className="text-center text-sm text-gray-400 mt-8">
            ...
            <p className="italic">"Find all hiphil imperatives in Deuteronomy"</p>
            <p className="italic">"What is the clause structure of Psalm 23:1?"</p>
          </div>
        )}
        {messages.map((msg, i) => (
